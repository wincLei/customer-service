...
const en = {
  ...
  features: {
    ...
    architecture: {
      ...
      description: 'Adopts microservice architecture design, supporting high concurrency and horizontal scaling',
      frontend: 'Frontend',
      frontendApp: 'Vue 3 Application',
      frontendDesc: 'Admin Panel + Visitor Portal + Mobile',
      api: 'API',
      backend: 'Backend Service',
      backendDesc: 'Spring Boot Microservices',
      im: 'IM',
      imDesc: 'WuKongIM Real-time Communication',
