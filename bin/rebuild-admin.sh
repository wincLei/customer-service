...
# =====================================================
# Admin 模块快速构建和重启脚本
# 用法: ./bin/rebuild-admin.sh [--skip-build] [--logs]
# =====================================================
...
echo -e "${BLUE}=============================================${NC}"
echo -e "${BLUE}   Admin 模块快速构建和重启${NC}"
echo -e "${BLUE}=============================================${NC}"
...
if [ "$SKIP_BUILD" = false ]; then
    ...
    # 编译 admin-module
    echo -e "${BLUE}  -> 编译 admin-module${NC}"
...
echo -e "\n${GREEN}=============================================${NC}"
echo -e "${GREEN}   Admin 模块更新完成! 耗时: ${ELAPSED}秒${NC}"
echo -e "${GREEN}=============================================${NC}"
